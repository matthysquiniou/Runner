...
namespace sr
{
    ...
    void Renderer::SetupDefaultLighting()
    {
        ...
        LightData directionalLight = LightManager::CreateDirectionalLight(LIGHT_DIR, Vector4(1.0f, 1.0f, 1.0f, 1.0f), 1.f, 1.0f);
        LightManager::AddLight(directionalLight); 

        LightManager::SetLightsProperties(8.0f, 100.0f, 2.0f, 32.0f, 0.1f);
        LightData directionalLight2 = LightManager::CreateDirectionalLight({1.f, -1.f,1.f}, Vector4(1.0f, 1.0f, 1.0f, 1.0f), 1.f, 1.0f);
        LightManager::AddLight(directionalLight2);

        LightManager::SetLightsProperties(8.0f, 100.0f, 2.0f, 32.0f, 0.1f);
        LightData directionalLight3 = LightManager::CreateDirectionalLight({-1.f, -1.f, 1.f}, Vector4(1.0f, 1.0f, 1.0f, 1.0f), 1.f, 1.0f);
        LightManager::AddLight(directionalLight3);
    }
